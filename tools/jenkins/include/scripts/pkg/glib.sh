...
# Install glib
# see http://www.linuxfromscratch.org/blfs/view/svn/general/glib2.html
...
GLIB_VERSION=2.74.0 # requires meson, but also a recent version of binutils
...
GLIB_SITE="https://download.gnome.org/sources/glib/${GLIB_VERSION_SHORT}"
...
if build_step && { force_build || { [ ! -s "$SDK_HOME/lib/pkgconfig/glib-2.0.pc" ] || [ "$(pkg-config --modversion glib-2.0)" != "$GLIB_VERSION" ]; }; }; then
    ...
    # apply patches from http://www.linuxfromscratch.org/blfs/view/svn/general/glib2.html
