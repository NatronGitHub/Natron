...
equals(QT_VERSION_MAJOR, 5) {
  ...
  shiboken:  LIBS += -L$$PYTHON_SITE_PACKAGES/shiboken2 -lshiboken2.cpython-$$PYVERNODOT-darwin.$${QT_VERSION_MAJOR}.$${QT_MINOR_VERSION}
  ...
  pyside:    LIBS += -L$$PYTHON_SITE_PACKAGES/PySide2 -lpyside2.cpython-$$PYVERNODOT-darwin.$${QT_VERSION_MAJOR}.$${QT_MINOR_VERSION}
