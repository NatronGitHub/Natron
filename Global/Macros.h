...
#define NATRON_VERSION_MAJOR NATRON_VERSION_MAJOR_25
#define NATRON_VERSION_MINOR NATRON_VERSION_MINOR_25
#define NATRON_VERSION_REVISION NATRON_VERSION_REVISION_25
