...
public:
    ...
    bool shouldAutoSetProjectFormat() const {return _currentProject.shouldAutoSetProjectFormat();}

    void setAutoSetProjectFormat(bool b){_currentProject.setAutoSetProjectFormat(b);}
