...
You'll need to install Qt 4.8 libraries from [Qt download](http://qt-project.org/downloads). Select the "Qt libraries 4.8.4 for Windows (VS 2010, 234 MB) "
Powiter will most likely upgrade to Qt5 soon, but for now it's not compatible with Qt5 fully. Once downloaded, remember the path where you install it as we will need it later on.
