...
1. When you first opened Natron, the Project Settings panel will appear. The Project Settings panel can be accessed manually from Display > Show Project Settings or by pressing "S" on the keyboard. From here you can adjust the the values to your needs.
2. (Project Paths).
