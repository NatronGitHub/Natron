...
0: Guess the thread count from the number of cores. The ideal threads count for this hardware is 4.
...
This setting indicates the percentage of the total RAM which can be used by the memory caches. This system has 8.00 GiB of RAM.
