...
class TableItem {
    ...
    struct ItemData
    {
        ...
        ItemData() : role(-1) , value() {}
        ItemData(int role,const QVariant& v) : role(role) , value(v) {}
        
        inline bool operator==(const ItemData &other) const { return role == other.role && value == other.value; }
    };
...
public:
    ...
    inline TableView *tableWidget() const { return view; }
...
inline void TableItem::setIcon(const QIcon &aicon)
{ setData(Qt::DecorationRole, aicon); }

inline void TableItem::setStatusTip(const QString &astatusTip)
{ setData(Qt::StatusTipRole, astatusTip); }

inline void TableItem::setToolTip(const QString &atoolTip)
{ setData(Qt::ToolTipRole, atoolTip); }

inline void TableItem::setFont(const QFont &afont)
...
public:
    ...
    TableModel(int rows,int columns,TableView* view);
