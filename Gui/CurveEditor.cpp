...
void
BezierEditorContext::getAnimCurveAndItem(QTreeWidgetItem** item,CurveGui** curve) const
{
    *item = _imp->curveItem;
...
{
    getWidget()->getCurveWidget()->removeCurve(_imp->animCurve);
