...
static void
createParenting(std::map<std::string,PaneLayout> & layout,
                std::map<std::string,PaneLayout>::iterator it)
{
...
static void
saveLayout(Gui* gui,
           std::map<std::string,PaneLayout> & layout,
           std::map<std::string,std::string> & splittersState)
{
