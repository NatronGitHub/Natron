...
void DocumentationManager::startServer()
{
...
void DocumentationManager::stopServer()
{
    server->close();
}

void DocumentationManager::handler(QHttpRequest *req, QHttpResponse *resp)
{
    Q_UNUSED(req)
...
QString DocumentationManager::parser(QString html, QString path) const
{
    QString result = html;
...
void DocumentationManager::setPort(int port)
{
#ifdef DEBUG
