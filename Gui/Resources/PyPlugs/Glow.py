...
def createInstance(app,group):
    ...
    lastNode.setPagesOrder(['controls', 'Node', 'Info', 'Settings'])
    ...
    group.PostGradeMasterSaturation.setAsAlias(groupPostGrade.getParam("MasterSaturation"))
    del param
    param = groupPostGrade.getParam("MasterGamma")
    group.PostGradeMasterGamma.setAsAlias(groupPostGrade.getParam("MasterGamma"))
    del param
    param = groupPostGrade.getParam("MasterGain")
    group.PostGradeMasterGain.setAsAlias(groupPostGrade.getParam("MasterGain"))
    del param
    param = groupMerge5.getParam("mix")
    param.setExpression("thisGroup.isolateHue.get()", False, 0)
    del param
    param = groupHSVTool1.getParam("srcColor")
    group.HSVTool1srcColor.setAsAlias(groupHSVTool1.getParam("srcColor"))
    del param
