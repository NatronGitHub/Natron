...
{ \
	...
	if(error != GL_NO_ERROR) { \
        ...
        public:
            ...
            void setCurrentViewerInfos(ViewerInfos *viewerInfos,bool onInit=false,bool initBoundaries = false);
            ViewerInfos* getCurrentViewerInfos(){return _currentViewerInfos;}
