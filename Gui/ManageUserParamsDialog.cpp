...
static QString
createTextForKnob(const KnobPtr& knob)
{
...
{
    if (!ensureHasUserPage()) {
        AddKnobDialog dialog(_imp->panel, KnobPtr(), std::string(), std::string(), this);
...
QTreeWidgetItem*
ManageUserParamsDialogPrivate::createItemForKnob(const KnobPtr& knob,
                                                 int insertIndex)
{
