...
bool
NodeGui::onOverlayPenDownDefault(const RenderScale & renderScale,
...
bool
NodeGui::onOverlayPenMotionDefault(const RenderScale & renderScale,
                                   const QPointF & viewportPos,
                                   const QPointF & pos,
                                   double pressure)
{
...
bool
NodeGui::onOverlayPenUpDefault(const RenderScale & renderScale,
                               const QPointF & viewportPos,
                               const QPointF & pos,
                               double pressure)
{
...
bool
NodeGui::onOverlayKeyDownDefault(const RenderScale & renderScale,
                                 Key key,
...
bool
NodeGui::onOverlayKeyUpDefault(const RenderScale & renderScale,
                               Key key,
                               KeyboardModifiers /*modifiers*/)
{
    if (_hostOverlay) {
...
bool
NodeGui::onOverlayKeyRepeatDefault(const RenderScale & renderScale,
                                   Key key,
                                   KeyboardModifiers /*modifiers*/)
{
    if (_hostOverlay) {
