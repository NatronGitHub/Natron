    ...
    , _shortcuts()
{
    ...
    (void)QT_TR_NOOP(kShortcutDescActionRotoDelete);
    (void)QT_TR_NOOP(kShortcutDescActionRotoCloseBezier);
    (void)QT_TR_NOOP(kShortcutDescActionRotoSelectAll);
    (void)QT_TR_NOOP(kShortcutDescActionRotoSelectionTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoAddTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoEditTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoBrushTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoCloneTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoEffectTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoColorTool);
    (void)QT_TR_NOOP(kShortcutDescActionRotoNudgeLeft);
    (void)QT_TR_NOOP(kShortcutDescActionRotoNudgeRight);
    (void)QT_TR_NOOP(kShortcutDescActionRotoNudgeBottom);
    (void)QT_TR_NOOP(kShortcutDescActionRotoNudgeTop);
    (void)QT_TR_NOOP(kShortcutDescActionRotoSmooth);
    (void)QT_TR_NOOP(kShortcutDescActionRotoCuspBezier);
    (void)QT_TR_NOOP(kShortcutDescActionRotoRemoveFeather);
    (void)QT_TR_NOOP(kShortcutDescActionRotoLinkToTrack);
    (void)QT_TR_NOOP(kShortcutDescActionRotoUnlinkToTrack);
    (void)QT_TR_NOOP(kShortcutDescActionRotoLockCurve);
