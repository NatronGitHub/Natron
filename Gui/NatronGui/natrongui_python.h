...
#define SBK_NATRONGUI_STD_MAP_QSTRING_NODECREATIONPROPERTYPTR_IDX    4 // const std::map<QString, NodeCreationProperty * > &
#define SBK_NATRONGUI_STD_LIST_EFFECTPTR_IDX                         5 // std::list<Effect * >
#define SBK_NATRONGUI_STD_LIST_QSTRING_IDX                           6 // std::list<QString >
#define SBK_NATRONGUI_STD_LIST_INT_IDX                               7 // const std::list<int > &
