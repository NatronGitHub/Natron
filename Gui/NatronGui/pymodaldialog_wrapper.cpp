...
const QMetaObject * PyModalDialogWrapper::metaObject() const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "PyModalDialog.metaObject", Shiboken::SbkType< QMetaObject >()->tp_name, pyResult->ob_type->tp_name);
        return ((::QMetaObject*)0);
    }
...
extern "C" {
static PyObject* Sbk_PyModalDialogFunc_activateUserParametersSupport(PyObject* self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // activateUserParametersSupport()
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            cppSelf->activateUserParametersSupport();
...
static PyMethodDef Sbk_PyModalDialog_methods[] = {
    {"activateUserParametersSupport", (PyCFunction)Sbk_PyModalDialogFunc_activateUserParametersSupport, METH_NOARGS},
...
static PyObject* PyModalDialog_PTR_CppToPython_PyModalDialog(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::PyModalDialog*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_PyModalDialog_Type, const_cast<void*>(cppIn), false, false, typeName);
}
