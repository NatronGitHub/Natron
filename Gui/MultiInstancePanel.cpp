...
bool
TrackerPanelPrivate::getTrackInstancesForButton(std::list<KnobButton*>* trackButtons,
...
void
TrackScheduler::track(int startingFrame,
                      int end,
                      bool forward,
                      const std::list<KnobButton*> & selectedInstances)
{
