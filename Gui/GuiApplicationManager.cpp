...
void
GuiApplicationManager::onPluginLoaded(const QStringList & groups,
...
const std::map<QString,std::map<QString,BoundAction*> >& GuiApplicationManager::getAllShortcuts() const
{
