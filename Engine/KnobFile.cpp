...
File_Knob::File_Knob(const boost::shared_ptr<KnobHolder>& holder, const std::string &description, int dimension)
...
OutputFile_Knob::OutputFile_Knob(const boost::shared_ptr<KnobHolder>& holder, const std::string &description, int dimension)
...
Path_Knob::Path_Knob(const boost::shared_ptr<KnobHolder>& holder, const std::string &description, int dimension)
: Knob(holder,description,dimension)
, _isMultiPath(false)
{
