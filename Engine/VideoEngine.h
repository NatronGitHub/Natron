...
public:
     ...
     * Generally the last node is an output node.
     */
    TreeReverseIterator rbegin() const
    {
        return _sorted.rbegin();
    }
     ...
     * Generally the first node is an input node.
     */
    TreeReverseIterator rend() const
    {
        return _sorted.rend();
    }
     ...
     */
    Natron::EffectInstance* getOutput() const
    {
        return _output;
    }
     ...
     */
    bool isOutputAnOpenFXNode() const
    {
        return _isOutputOpenFXNode;
    }
    ...
    bool wasTreeEverBuilt() const
    {
        return _wasEverBuilt;
    }
...
public slots:
    ...
    void abortRenderingNonBlocking()
    {
...
public:
    ...
    VideoEngine(Natron::OutputEffectInstance* owner,
                QObject* parent = NULL);
    ...
    void setNodesKnobsFrozen(bool frozen)
    {
        _tree.setNodesKnobsFrozen(frozen);
    }
