...
{
    _generalTab = natronCreateKnob<KnobPage>(this, "General");

    _natronSettingsExist = natronCreateKnob<KnobBool>(this, "Existing settings");
    ...
    _checkForUpdates = natronCreateKnob<KnobBool>(this, "Always check for updates on start-up");
    ...
    _enableCrashReports = natronCreateKnob<KnobBool>(this, "Enable crash reporting");
    ...
    _notifyOnFileChange = natronCreateKnob<KnobBool>(this, "Warn when a file changes externally");
    ...
    _autoSaveDelay = natronCreateKnob<KnobInt>(this, "Auto-save trigger delay");
    ...
    _linearPickers = natronCreateKnob<KnobBool>(this, "Linear color pickers");
    ...
    _convertNaNValues = natronCreateKnob<KnobBool>(this, "Convert NaN values");
    ...
    _numberOfThreads = natronCreateKnob<KnobInt>(this, "Number of render threads (0=\"guess\")");
    ...
    _numberOfParallelRenders = natronCreateKnob<KnobInt>(this, "Number of parallel renders (0=\"guess\")");
    ...
    _useThreadPool = natronCreateKnob<KnobBool>(this, "Effects use thread-pool");
    ...
    _nThreadsPerEffect = natronCreateKnob<KnobInt>(this, "Max threads usable per effect (0=\"guess\")");
    ...
    _renderInSeparateProcess = natronCreateKnob<KnobBool>(this, "Render in a separate process");
    ...
    _autoPreviewEnabledForNewProjects = natronCreateKnob<KnobBool>(this, "Auto-preview enabled by default for new projects");
    ...
    _firstReadSetProjectFormat = natronCreateKnob<KnobBool>(this, "First image read set project format");
    ...
    _fixPathsOnProjectPathChanged = natronCreateKnob<KnobBool>(this, "Auto fix relative file-paths");
    ...
    _maxPanelsOpened = natronCreateKnob<KnobInt>(this, "Maximum number of open settings panels (0=\"unlimited\")");
    ...
    _useCursorPositionIncrements = natronCreateKnob<KnobBool>(this, "Value increments based on cursor position");
    ...
    _defaultLayoutFile = natronCreateKnob<KnobFile>(this, "Default layout file");
    ...
    _loadProjectsWorkspace = natronCreateKnob<KnobBool>(this, "Load workspace embedded within projects");
    ...
    _renderOnEditingFinished = natronCreateKnob<KnobBool>(this, "Refresh viewer only when editing is finished");
    ...
    _activateRGBSupport = natronCreateKnob<KnobBool>(this, "RGB components support");
    ...
    _activateTransformConcatenationSupport = natronCreateKnob<KnobBool>(this, "Transforms concatenation support");
    ...
    _hostName = natronCreateKnob<KnobChoice>(this, "Appear to plug-ins as");
    ...
    _customHostName = natronCreateKnob<KnobString>(this, "Custom Host name");
...
{
    //////////////APPEARANCE TAB/////////////////
    _appearanceTab = natronCreateKnob<KnobPage>(this, "Appearance");
    
    _defaultAppearanceVersion = natronCreateKnob<KnobInt>(this, "Appearance version");
    ...
    _systemFontChoice = natronCreateKnob<KnobChoice>(this, "Font");
    ...
    _fontSize = natronCreateKnob<KnobInt>(this, "Font size");
    _fontSize->setName("fontSize");
    _fontSize->setAnimationEnabled(false);
    _appearanceTab->addKnob(_fontSize);
    
    _qssFile = natronCreateKnob<KnobFile>(this, "Stylesheet file (.qss)");
    ...
    _guiColors = natronCreateKnob<KnobGroup>(this, "GUI colors");
    _guiColors->setAsTab();
    _appearanceTab->addKnob(_guiColors);
    
    _curveEditorColors = natronCreateKnob<KnobGroup>(this, "Curve Editor");
    _curveEditorColors->setAsTab();
    _appearanceTab->addKnob(_curveEditorColors);

    _dopeSheetEditorColors = natronCreateKnob<KnobGroup>(this, "Dope Sheet");
    _dopeSheetEditorColors->setAsTab();
    _appearanceTab->addKnob(_dopeSheetEditorColors);
    
    _scriptEditorColors = natronCreateKnob<KnobGroup>(this, "Script Editor");
    _scriptEditorColors->setAsTab();
    _appearanceTab->addKnob(_scriptEditorColors);
    
    _sunkenColor =  natronCreateKnob<KnobColor>(this, "Sunken",3);
    ...
    _baseColor =  natronCreateKnob<KnobColor>(this, "Base",3);
    ...
    _raisedColor =  natronCreateKnob<KnobColor>(this, "Raised",3);
    ...
    _selectionColor =  natronCreateKnob<KnobColor>(this, "Selection",3);
    ...
    _textColor =  natronCreateKnob<KnobColor>(this, "Text",3);
    ...
    _altTextColor =  natronCreateKnob<KnobColor>(this, "Unmodified text",3);
    ...
    _timelinePlayheadColor =  natronCreateKnob<KnobColor>(this, "Timeline playhead",3);
    ...
    _timelineBGColor =  natronCreateKnob<KnobColor>(this, "Timeline background",3);
    ...
    _timelineBoundsColor =  natronCreateKnob<KnobColor>(this, "Timeline bounds",3);
    ...
    _cachedFrameColor =  natronCreateKnob<KnobColor>(this, "Cached frame",3);
    ...
    _diskCachedFrameColor =  natronCreateKnob<KnobColor>(this, "Disk cached frame",3);
    ...
    _interpolatedColor =  natronCreateKnob<KnobColor>(this, "Interpolated value",3);
    ...
    _keyframeColor =  natronCreateKnob<KnobColor>(this, "Keyframe",3);
    ...
    _exprColor =  natronCreateKnob<KnobColor>(this, "Expression",3);
    ...
    _curveEditorBGColor =  natronCreateKnob<KnobColor>(this, "Background color",3);
    ...
    _gridColor =  natronCreateKnob<KnobColor>(this, "Grid color",3);
    ...
    _curveEditorScaleColor =  natronCreateKnob<KnobColor>(this, "Scale color",3);
    ...
    _dopeSheetEditorBackgroundColor = natronCreateKnob<KnobColor>(this, "Sheet background color", 3);
    ...
    _dopeSheetEditorRootSectionBackgroundColor = natronCreateKnob<KnobColor>(this, "Root section background color", 4);
    ...
    _dopeSheetEditorKnobSectionBackgroundColor = natronCreateKnob<KnobColor>(this, "Knob section background color", 4);
    ...
    _dopeSheetEditorScaleColor = natronCreateKnob<KnobColor>(this, "Sheet scale color", 3);
    ...
    _dopeSheetEditorGridColor = natronCreateKnob<KnobColor>(this, "Sheet grid color", 3);
    ...
    _curLineColor = natronCreateKnob<KnobColor>(this, "Current Line Color", 3);
    ...
    _keywordColor = natronCreateKnob<KnobColor>(this, "Keyword Color", 3);
    ...
    _operatorColor = natronCreateKnob<KnobColor>(this, "Operator Color", 3);
    ...
    _braceColor = natronCreateKnob<KnobColor>(this, "Brace Color", 3);
    ...
    _defClassColor = natronCreateKnob<KnobColor>(this, "Class Def Color", 3);
    ...
    _stringsColor = natronCreateKnob<KnobColor>(this, "Strings Color", 3);
    ...
    _commentsColor = natronCreateKnob<KnobColor>(this, "Comments Color", 3);
    ...
    _selfColor = natronCreateKnob<KnobColor>(this, "Self Color", 3);
    ...
    _numbersColor = natronCreateKnob<KnobColor>(this, "Numbers Color", 3);
    ...
    boost::shared_ptr<KnobPage> ocioTab = natronCreateKnob<KnobPage>(this, "OpenColorIO");
    _ocioConfigKnob = natronCreateKnob<KnobChoice>(this, "OpenColorIO config");
    ...
    _customOcioConfigFile = natronCreateKnob<KnobFile>(this, "Custom OpenColorIO config file");
    ...
    _warnOcioConfigKnobChanged = natronCreateKnob<KnobBool>(this, "Warn on OpenColorIO config change");
    ...
    _ocioStartupCheck = natronCreateKnob<KnobBool>(this, "Warn on startup if OpenColorIO config is not the default");
...
{
    _viewersTab = natronCreateKnob<KnobPage>(this, "Viewers");

    _texturesMode = natronCreateKnob<KnobChoice>(this, "Viewer textures bit depth");
    ...
    _powerOf2Tiling = natronCreateKnob<KnobInt>(this, "Viewer tile size is 2 to the power of...");
    ...
    _checkerboardTileSize = natronCreateKnob<KnobInt>(this, "Checkerboard tile size (pixels)");
    ...
    _checkerboardColor1 = natronCreateKnob<KnobColor>(this, "Checkerboard color 1",4);
    ...
    _checkerboardColor2 = natronCreateKnob<KnobColor>(this, "Checkerboard color 2",4);
    ...
    _autoWipe = natronCreateKnob<KnobBool>(this, "Automatically enable wipe");
    ...
    _autoProxyWhenScrubbingTimeline = natronCreateKnob<KnobBool>(this, "Automatically enable proxy when scrubbing the timeline");
    ...
    _autoProxyLevel = natronCreateKnob<KnobChoice>(this, "Auto-proxy level");
    ...
    _enableProgressReport = natronCreateKnob<KnobBool>(this, "Enable progress-report (experimental, slower)");
...
{
    /////////// Nodegraph tab
    _nodegraphTab = natronCreateKnob<KnobPage>(this, "Nodegraph");
    
    _autoTurbo = natronCreateKnob<KnobBool>(this, "Auto-turbo");
    ...
    _snapNodesToConnections = natronCreateKnob<KnobBool>(this, "Snap to node");
    ...
    _useBWIcons = natronCreateKnob<KnobBool>(this, "Use black & white toolbutton icons");
    ...
    _useNodeGraphHints = natronCreateKnob<KnobBool>(this, "Use connection hints");
    ...
    _maxUndoRedoNodeGraph = natronCreateKnob<KnobInt>(this, "Maximum undo/redo for the node graph");
    ...
    _disconnectedArrowLength = natronCreateKnob<KnobInt>(this, "Disconnected arrow length");
    ...
    _hideOptionalInputsAutomatically = natronCreateKnob<KnobBool>(this, "Auto hide masks inputs");
    ...
    _useInputAForMergeAutoConnect = natronCreateKnob<KnobBool>(this,"Merge node connect to A input");
    ...
    _usePluginIconsInNodeGraph = natronCreateKnob<KnobBool>(this, "Display plug-in icon on node-graph");
    ...
    _useAntiAliasing = natronCreateKnob<KnobBool>(this, "Anti-Aliasing");
    ...
    _defaultNodeColor = natronCreateKnob<KnobColor>(this, "Default node color",3);
    ...
    _defaultBackdropColor =  natronCreateKnob<KnobColor>(this, "Default backdrop color",3);
    ...
    _defaultReaderColor =  natronCreateKnob<KnobColor>(this, PLUGIN_GROUP_IMAGE_READERS,3);
    ...
    _defaultWriterColor =  natronCreateKnob<KnobColor>(this, PLUGIN_GROUP_IMAGE_WRITERS,3);
    ...
    _defaultGeneratorColor =  natronCreateKnob<KnobColor>(this, "Generators",3);
    ...
    _defaultColorGroupColor =  natronCreateKnob<KnobColor>(this, "Color group",3);
    ...
    _defaultFilterGroupColor =  natronCreateKnob<KnobColor>(this, "Filter group",3);
    ...
    _defaultTransformGroupColor =  natronCreateKnob<KnobColor>(this, "Transform group",3);
    ...
    _defaultTimeGroupColor =  natronCreateKnob<KnobColor>(this, "Time group",3);
    ...
    _defaultDrawGroupColor =  natronCreateKnob<KnobColor>(this, "Draw group",3);
    ...
    _defaultKeyerGroupColor =  natronCreateKnob<KnobColor>(this, "Keyer group",3);
    ...
    _defaultChannelGroupColor =  natronCreateKnob<KnobColor>(this, "Channel group",3);
    ...
    _defaultMergeGroupColor =  natronCreateKnob<KnobColor>(this, "Merge group",3);
    ...
    _defaultViewsGroupColor =  natronCreateKnob<KnobColor>(this, "Views group",3);
    ...
    _defaultDeepGroupColor =  natronCreateKnob<KnobColor>(this, "Deep group",3);
...
{
    /////////// Caching tab
    _cachingTab = natronCreateKnob<KnobPage>(this, "Caching");

    _aggressiveCaching = natronCreateKnob<KnobBool>(this, "Aggressive caching");
    ...
    _maxRAMPercent = natronCreateKnob<KnobInt>(this, "Maximum amount of RAM memory used for caching (% of total RAM)");
    ...
    _maxRAMLabel = natronCreateKnob<KnobString>(this, "");
    ...
    _maxPlayBackPercent = natronCreateKnob<KnobInt>(this, "Playback cache RAM percentage (% of maximum RAM used for caching)");
    ...
    _maxPlaybackLabel = natronCreateKnob<KnobString>(this, "");
    ...
    _unreachableRAMPercent = natronCreateKnob<KnobInt>(this, "System RAM to keep free (% of total RAM)");
    ...
    _unreachableRAMLabel = natronCreateKnob<KnobString>(this, "");
    ...
    _maxViewerDiskCacheGB = natronCreateKnob<KnobInt>(this, "Maximum playback disk cache size (GiB)");
    ...
    _maxDiskCacheNodeGB = natronCreateKnob<KnobInt>(this, "Maximum DiskCache node disk usage (GiB)");
    ...
    _diskCachePath = natronCreateKnob<KnobPath>(this, "Disk cache path (empty = default)");
    ...
    _wipeDiskCache = natronCreateKnob<KnobButton>(this, "Wipe Disk Cache");
...
Settings::initializeKnobsReaders()
{
    ...
    _readersTab = natronCreateKnob<KnobPage>(this, PLUGIN_GROUP_IMAGE_READERS);
...
{
    _writersTab = natronCreateKnob<KnobPage>(this, PLUGIN_GROUP_IMAGE_WRITERS);
...
{
    _pluginsTab = natronCreateKnob<KnobPage>(this, "Plug-ins");
    _pluginsTab->setName("plugins");
    
    _extraPluginPaths = natronCreateKnob<KnobPath>(this, "OpenFX plugins search path");
    ...
    _templatesPluginPaths = natronCreateKnob<KnobPath>(this, "PyPlugs search path");
    ...
    _loadBundledPlugins = natronCreateKnob<KnobBool>(this, "Use bundled plugins");
    ...
    _preferBundledPlugins = natronCreateKnob<KnobBool>(this, "Prefer bundled plugins over system-wide plugins");
...
{
    _pythonPage = natronCreateKnob<KnobPage>(this, "Python");
    
    
    _onProjectCreated = natronCreateKnob<KnobString>(this, "After project created");
    ...
    _defaultOnProjectLoaded = natronCreateKnob<KnobString>(this, "Default after project loaded");
    ...
    _defaultOnProjectSave = natronCreateKnob<KnobString>(this, "Default before project save");
    ...
    _defaultOnProjectClose = natronCreateKnob<KnobString>(this, "Default before project close");
    ...
    _defaultOnNodeCreated = natronCreateKnob<KnobString>(this, "Default after node created");
    ...
    _defaultOnNodeDelete = natronCreateKnob<KnobString>(this, "Default before node removal");
    ...
    _loadPyPlugsFromPythonScript = natronCreateKnob<KnobBool>(this, "Load PyPlugs in projects from .py if possible");
    ...
    _echoVariableDeclarationToPython = natronCreateKnob<KnobBool>(this, "Print auto-declared variables in the Script Editor");
...
Settings::warnChangedKnobs(const std::vector<KnobI*>& knobs)
{
    ...
    for (U32 i = 0; i < knobs.size(); ++i) {
        if ((knobs[i] == _fontSize.get() ||
            ...
            didOCIOWarn = true;
            natronWarningDialog(QObject::tr("Font change").toStdString(),
            ...
            if (warnOcioChanged) {
                ...
                natronWarningDialog(QObject::tr("OCIO config changed").toStdString(),
                ...
                for (std::list<ViewerInstance*>::iterator it = allViewers.begin(); it != allViewers.end(); ++it) {
                    ...
                    if (isFirstViewer) {
                        if ( !(*it)->supportsGLSL() && (_texturesMode->getValue() != 0) ) {
                            natronErrorDialog( QObject::tr("Viewer").toStdString(), QObject::tr("You need OpenGL GLSL in order to use 32 bit fp textures.\n"
...
Settings::tryLoadOpenColorIOConfig()
{
    ...
    if ( _customOcioConfigFile->isEnabled(0) ) {
        ...
        if ( !QFile::exists( file.c_str() ) ) {
            natronErrorDialog( "OpenColorIO", file + QObject::tr(": No such file.").toStdString() );
        ...
        try {
            ...
            for (int i = 0; i < defaultConfigsPaths.size(); ++i) {
                ...
                if ( !defaultConfigsDir.exists(configFileName) ) {
                    ...
                    if ( !subDir.exists() ) {
                        natronErrorDialog( "OpenColorIO",subDir.absoluteFilePath("config.ocio").toStdString() + QObject::tr(": No such file or directory.").toStdString() );
                             ...
                             bool /*originatedFromMainThread*/)
{
    ...
    if ((k == _hostName.get() || k == _customHostName.get()) && !_restoringSettings) {
        natronWarningDialog(tr("Host-name change").toStdString(), tr("Changing this requires a restart of " NATRON_APPLICATION_NAME
...
Settings::populateReaderPluginsAndFormats(const std::map<std::string,std::vector< std::pair<std::string,double> > > & rows)
{
    ...
    for (std::map<std::string,std::vector< std::pair<std::string,double> > >::const_iterator it = rows.begin(); it != rows.end(); ++it) {
        boost::shared_ptr<KnobChoice> k = natronCreateKnob<KnobChoice>(this, it->first);
...
Settings::populatePluginsTab()
{
    ...
    for (std::map< std::string,std::string >::iterator it = groupNames.begin(); it != groupNames.end(); ++it) {
        boost::shared_ptr<KnobGroup>  g = natronCreateKnob<KnobGroup>(this, it->second);
        g->setName(it->first);
    ...
    for (PluginsMap::const_iterator it = plugins.begin(); it != plugins.end(); ++it) {
        ...
        for (PluginMajorsOrdered::const_iterator it2 = it->second.begin(); it2 != it->second.end(); ++it2) {
            ...
            boost::shared_ptr<KnobString> pluginLabel = natronCreateKnob<KnobString>(this, pluginName);
            ...
            boost::shared_ptr<KnobBool> pluginActivation = natronCreateKnob<KnobBool>(this, "Enabled");
            ...
            boost::shared_ptr<KnobChoice> zoomSupport = natronCreateKnob<KnobChoice>(this, "Zoom support");
    ...
    if (docheck && mainInstance) {
        ...
        if (reply == eStandardButtonYes) {
            ...
            if (defaultIndex != -1) {
                ...
                natronWarningDialog("OCIO config", QObject::tr("The " NATRON_DEFAULT_OCIO_CONFIG_NAME " config could not be found. "
