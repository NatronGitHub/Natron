...
ImageFetcher::ImageFetcher(Node* node,
                           SequenceTime time,
                           int x,
                           int y,
                           int r,
...
void
ImageFetcher::claimInterest(bool blocking)
{
...
boost::shared_ptr<const Row> ImageFetcher::getInputRow(Node* node,
                                                       SequenceTime time,
                                                       int y,
                                                       int x,
                                                       int r,
...
void
ImageFetcher::notifyFinishedAt(int y)
{
    emit hasFinishedAt(y);
}

void
ImageFetcher::debugImageFetcher(const std::string & filename)
{
    int w = _r - _x;
    int h = _t - _y + 1;
