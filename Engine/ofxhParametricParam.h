...
/**
 * @brief Must be called on the Param::Descriptor and ParametricInstance of a parametric param
 * in order to fill the properties specific to parametric parameters.
 **/
