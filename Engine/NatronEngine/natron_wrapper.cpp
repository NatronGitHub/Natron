...
extern "C" {
static PyObject* Sbk_NatronFunc_errorDialog(PyObject* self, PyObject* args)
{
    int overloadId = -1;
    ...
    if (overloadId == -1) goto Sbk_NatronFunc_errorDialog_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            ::Natron::errorDialog(cppArg0, cppArg1);
    ...
    Sbk_NatronFunc_errorDialog_TypeError:
        const char* overloads[] = {"std::string, std::string", 0};
        Shiboken::setErrorAboutWrongArguments(args, "NatronEngine.Natron.errorDialog", overloads);
        return 0;
}

static PyObject* Sbk_NatronFunc_getNumInstances(PyObject* self)
{
    PyObject* pyResult = 0;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getNumInstances()
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            int cppResult = ::Natron::getNumInstances();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
...
static PyObject* Sbk_NatronFunc_getPluginIDs(PyObject* self)
{
    PyObject* pyResult = 0;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getPluginIDs()
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            std::list<std::string > cppResult = ::Natron::getPluginIDs();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
...
static PyObject* Sbk_NatronFunc_informationDialog(PyObject* self, PyObject* args)
{
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { 0, 0 };
    SBK_UNUSED(pythonToCpp)
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_NatronFunc_informationDialog_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            ::Natron::informationDialog(cppArg0, cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_NatronFunc_informationDialog_TypeError:
        const char* overloads[] = {"std::string, std::string", 0};
        Shiboken::setErrorAboutWrongArguments(args, "NatronEngine.Natron.informationDialog", overloads);
        return 0;
}

static PyObject* Sbk_NatronFunc_questionDialog(PyObject* self, PyObject* args, PyObject* kwds)
{
    PyObject* pyResult = 0;
    int overloadId = -1;
    ...
    if (numArgs + numNamedArgs > 4) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.questionDialog(): too many arguments");
        return 0;
    } else if (numArgs < 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.questionDialog(): not enough arguments");
        return 0;
    }

    if (!PyArg_ParseTuple(args, "|OOOO:questionDialog", &(pyArgs[0]), &(pyArgs[1]), &(pyArgs[2]), &(pyArgs[3])))
        return 0;


    // Overloaded function decisor
    // 0: questionDialog(std::string,std::string,QFlags<Natron::StandardButton>,Natron::StandardButton)
    if (numArgs >= 2
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<std::string>(), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<std::string>(), (pyArgs[1])))) {
        if (numArgs == 2) {
            overloadId = 0; // questionDialog(std::string,std::string,QFlags<Natron::StandardButton>,Natron::StandardButton)
        } else if ((pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkNatronEngineTypes[SBK_QFLAGS_NATRON_STANDARDBUTTON__IDX]), (pyArgs[2])))) {
            if (numArgs == 3) {
                overloadId = 0; // questionDialog(std::string,std::string,QFlags<Natron::StandardButton>,Natron::StandardButton)
            } else if ((pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkNatronEngineTypes[SBK_NATRON_STANDARDBUTTON_IDX]), (pyArgs[3])))) {
                overloadId = 0; // questionDialog(std::string,std::string,QFlags<Natron::StandardButton>,Natron::StandardButton)
            }
        }
    }
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_NatronFunc_questionDialog_TypeError;
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[2]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.questionDialog(): got multiple values for keyword argument 'buttons'.");
                return 0;
            } else if (value) {
                pyArgs[2] = value;
                if (!(pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkNatronEngineTypes[SBK_QFLAGS_NATRON_STANDARDBUTTON__IDX]), (pyArgs[2]))))
                    goto Sbk_NatronFunc_questionDialog_TypeError;
            }
            value = PyDict_GetItemString(kwds, "defaultButton");
            if (value && pyArgs[3]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.questionDialog(): got multiple values for keyword argument 'defaultButton'.");
                return 0;
            } else if (value) {
                pyArgs[3] = value;
                if (!(pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkNatronEngineTypes[SBK_NATRON_STANDARDBUTTON_IDX]), (pyArgs[3]))))
                    goto Sbk_NatronFunc_questionDialog_TypeError;
            }
        }
        ::std::string cppArg0;
        ...
        ::std::string cppArg1;
        pythonToCpp[1](pyArgs[1], &cppArg1);
        ::QFlags<Natron::StandardButton> cppArg2 = Natron::StandardButtons(Natron::Yes | Natron::No);
        if (pythonToCpp[2]) pythonToCpp[2](pyArgs[2], &cppArg2);
        ::Natron::StandardButton cppArg3 = Natron::NoButton;
        if (pythonToCpp[3]) pythonToCpp[3](pyArgs[3], &cppArg3);

        if (!PyErr_Occurred()) {
            // questionDialog(std::string,std::string,QFlags<Natron::StandardButton>,Natron::StandardButton)
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Natron::StandardButton cppResult = ::Natron::questionDialog(cppArg0, cppArg1, cppArg2, cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython(SBK_CONVERTER(SbkNatronEngineTypes[SBK_NATRON_STANDARDBUTTON_IDX]), &cppResult);
        }
    }
    ...
    Sbk_NatronFunc_questionDialog_TypeError:
        const char* overloads[] = {"std::string, std::string, NatronEngine.Natron.StandardButtons = Natron.StandardButtons(Natron.Yes | Natron.No), NatronEngine.Natron.StandardButton = Natron.NoButton", 0};
        Shiboken::setErrorAboutWrongArguments(args, "NatronEngine.Natron.questionDialog", overloads);
        return 0;
}

static PyObject* Sbk_NatronFunc_warningDialog(PyObject* self, PyObject* args)
{
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { 0, 0 };
    SBK_UNUSED(pythonToCpp)
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_NatronFunc_warningDialog_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            ::Natron::warningDialog(cppArg0, cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_NatronFunc_warningDialog_TypeError:
        const char* overloads[] = {"std::string, std::string", 0};
        Shiboken::setErrorAboutWrongArguments(args, "NatronEngine.Natron.warningDialog", overloads);
        return 0;
}

static PyMethodDef Sbk_Natron_methods[] = {
    {"errorDialog", (PyCFunction)Sbk_NatronFunc_errorDialog, METH_VARARGS|METH_STATIC},
    {"getNumInstances", (PyCFunction)Sbk_NatronFunc_getNumInstances, METH_NOARGS|METH_STATIC},
    {"getPluginIDs", (PyCFunction)Sbk_NatronFunc_getPluginIDs, METH_NOARGS|METH_STATIC},
    {"informationDialog", (PyCFunction)Sbk_NatronFunc_informationDialog, METH_VARARGS|METH_STATIC},
    {"questionDialog", (PyCFunction)Sbk_NatronFunc_questionDialog, METH_VARARGS|METH_KEYWORDS|METH_STATIC},
    {"warningDialog", (PyCFunction)Sbk_NatronFunc_warningDialog, METH_VARARGS|METH_STATIC},
