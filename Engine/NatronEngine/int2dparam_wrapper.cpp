...
extern "C" {
static PyObject* Sbk_Int2DParamFunc_get(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (numArgs + numNamedArgs > 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Int2DParam.get(): too many arguments");
        return 0;
    }
    ...
    switch (overloadId) {
        case 0: // get(const QString & view) const
        {
            if (kwds) {
                ...
                if (value && pyArgs[0]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Int2DParam.get(): got multiple values for keyword argument 'view'.");
                    return 0;
                } else if (value) {
                    pyArgs[0] = value;
                    if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[0]))))
                        goto Sbk_Int2DParamFunc_get_TypeError;
                }
            }
        ...
        case 1: // get(double frame, const QString & view) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                Int2DTuple* cppResult = new Int2DTuple(const_cast<const ::Int2DParamWrapper*>(cppSelf)->get(cppArg0, cppArg1));
                pyResult = Shiboken::Object::newObject((SbkObjectType*)SbkNatronEngineTypes[SBK_INT2DTUPLE_IDX], cppResult, true, true);
            }
            break;
        }
...
static PyObject* Sbk_Int2DParamFunc_set(PyObject* self, PyObject* args, PyObject* kwds)
{
    Int2DParamWrapper* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    if (numArgs + numNamedArgs > 4) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Int2DParam.set(): too many arguments");
        return 0;
    } else if (numArgs < 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Int2DParam.set(): not enough arguments");
        return 0;
    }
    ...
    // Overloaded function decisor
    // 0: set(int,int,QString)
    // 1: set(int,int,double,QString)
    if (numArgs >= 2
        ...
        if (numArgs == 2) {
            ...
            if (numArgs == 3) {
                overloadId = 1; // set(int,int,double,QString)
    ...
    switch (overloadId) {
        case 0: // set(int x, int y, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[2]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Int2DParam.set(): got multiple values for keyword argument 'view'.");
                    return 0;
                } else if (value) {
                    pyArgs[2] = value;
                    if (!(pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[2]))))
                        goto Sbk_Int2DParamFunc_set_TypeError;
                }
            }
            int cppArg0;
            pythonToCpp[0](pyArgs[0], &cppArg0);
        ...
        case 1: // set(int x, int y, double frame, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[3]) {
    ...
    Sbk_Int2DParamFunc_set_TypeError:
        const char* overloads[] = {"int, int, unicode = QLatin1String(\"All\")", "int, int, float, unicode = QLatin1String(\"All\")", 0};
        Shiboken::setErrorAboutWrongArguments(args, "NatronEngine.Int2DParam.set", overloads);
        return 0;
}

static PyMethodDef Sbk_Int2DParam_methods[] = {
    {"get", (PyCFunction)Sbk_Int2DParamFunc_get, METH_VARARGS|METH_KEYWORDS},
    {"set", (PyCFunction)Sbk_Int2DParamFunc_set, METH_VARARGS|METH_KEYWORDS},
