...
#define SBK_NATRON_STANDARDBUTTONENUM_IDX                            35
#define SBK_QFLAGS_NATRON_STANDARDBUTTONENUM__IDX                    46
#define SBK_NATRON_IMAGECOMPONENTSENUM_IDX                           29
#define SBK_NATRON_IMAGEBITDEPTHENUM_IDX                             28
#define SBK_NATRON_KEYFRAMETYPEENUM_IDX                              31
#define SBK_NATRON_VALUECHANGEDREASONENUM_IDX                        37
#define SBK_NATRON_ANIMATIONLEVELENUM_IDX                            27
#define SBK_NATRON_ORIENTATIONENUM_IDX                               32
#define SBK_NATRON_IMAGEPREMULTIPLICATIONENUM_IDX                    30
#define SBK_NATRON_STATUSENUM_IDX                                    36
#define SBK_NATRON_VIEWERCOMPOSITINGOPERATORENUM_IDX                 39
#define SBK_NATRON_PLAYBACKMODEENUM_IDX                              34
#define SBK_NATRON_PIXMAPENUM_IDX                                    33
#define SBK_NATRON_VIEWERCOLORSPACEENUM_IDX                          38
...
#define SBK_PARAMETRICPARAM_IDX                                      43
#define SBK_PAGEPARAM_IDX                                            41
#define SBK_GROUPPARAM_IDX                                           18
#define SBK_BUTTONPARAM_IDX                                          6
#define SBK_PATHPARAM_IDX                                            44
#define SBK_OUTPUTFILEPARAM_IDX                                      40
...
#define SBK_NATRONENGINE_STD_PAIR_STD_STRING_STD_STRING_IDX          1 // std::pair<std::string, std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_STD_STRING_STD_STRING_IDX 2 // const std::list<std::pair<std::string, std::string > > &
...
#define SBK_NATRONENGINE_STD_LIST_RENDERTASK_IDX                     6 // const std::list<RenderTask > &
#define SBK_NATRONENGINE_STD_LIST_STD_STRING_IDX                     7 // std::list<std::string >
#define SBK_NATRONENGINE_QLIST_QVARIANT_IDX                          8 // QList<QVariant >
#define SBK_NATRONENGINE_QLIST_QSTRING_IDX                           9 // QList<QString >
#define SBK_NATRONENGINE_QMAP_QSTRING_QVARIANT_IDX                   10 // QMap<QString, QVariant >
#define SBK_NatronEngine_CONVERTERS_IDX_COUNT                        11
...
template<> inline PyTypeObject* SbkType< ::RenderTask >() { return reinterpret_cast<PyTypeObject*>(SbkNatronEngineTypes[SBK_RENDERTASK_IDX]); }
