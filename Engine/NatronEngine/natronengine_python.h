...
#define SBK_NATRONENGINE_STD_LIST_RENDERTASK_IDX                     4 // const std::list<RenderTask > &
#define SBK_NATRONENGINE_STD_LIST_STD_STRING_IDX                     5 // std::list<std::string >
#define SBK_NATRONENGINE_STD_PAIR_STD_STRING_STD_STRING_IDX          6 // std::pair<std::string, std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_STD_STRING_STD_STRING_IDX 7 // const std::list<std::pair<std::string, std::string > > &
