...
#define SBK_NATRONENGINE_STD_LIST_PARAMPTR_IDX                       1 // std::list<Param * >
#define SBK_NATRONENGINE_STD_LIST_EFFECTPTR_IDX                      2 // std::list<Effect * >
#define SBK_NATRONENGINE_STD_LIST_INT_IDX                            3 // const std::list<int > &
#define SBK_NATRONENGINE_STD_LIST_STD_STRING_IDX                     4 // std::list<std::string >
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        5 // std::vector<RectI >
