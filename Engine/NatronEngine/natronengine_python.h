...
<<<<<<< HEAD
#define SBK_NATRONENGINE_STD_VECTOR_DOUBLE_IDX                       1 // const std::vector<double > &
#define SBK_NATRONENGINE_STD_LIST_RECTI_IDX                          2 // std::list<RectI >
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   3 // std::vector<std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          4 // std::list<std::vector<std::string > > *
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        5 // std::list<QString > *
#define SBK_NATRONENGINE_STD_MAP_QSTRING_PYOVERLAYPARAMDESC_IDX      6 // std::map<QString, PyOverlayParamDesc >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_QSTRING_IDX                 7 // const std::map<QString, QString > &
#define SBK_NATRONENGINE_STD_LIST_ITEMBASEPTR_IDX                    8 // std::list<ItemBase * >
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       9 // const std::list<Track * > &
#define SBK_NATRONENGINE_STD_LIST_PARAMPTR_IDX                       10 // std::list<Param * >
#define SBK_NATRONENGINE_STD_LIST_DOUBLE_IDX                         11 // std::list<double > *
...
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                4 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       5 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       6 // std::list<Track * > *
#define SBK_NATRONENGINE_STD_LIST_PARAMPTR_IDX                       7 // std::list<Param * >
#define SBK_NATRONENGINE_STD_LIST_DOUBLE_IDX                         8 // std::list<double > *
...
#define SBK_NATRONENGINE_STD_VECTOR_BOOL_IDX                         11 // const std::vector<bool > &
#define SBK_NATRONENGINE_STD_VECTOR_INT_IDX                          12 // const std::vector<int > &
#define SBK_NATRONENGINE_STD_LIST_EFFECTPTR_IDX                      13 // std::list<Effect * >
#define SBK_NATRONENGINE_STD_LIST_IMAGELAYER_IDX                     14 // std::list<ImageLayer >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_NODECREATIONPROPERTYPTR_IDX 15 // const std::map<QString, NodeCreationProperty * > &
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        16 // std::list<QString >
#define SBK_NATRONENGINE_STD_LIST_INT_IDX                            17 // const std::list<int > &
