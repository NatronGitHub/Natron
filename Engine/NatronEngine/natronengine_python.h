...
#define SBK_NATRONENGINE_STD_PAIR_STD_STRING_STD_STRING_IDX          5 // std::pair<std::string, std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_STD_STRING_STD_STRING_IDX 6 // const std::list<std::pair<std::string, std::string > > &
