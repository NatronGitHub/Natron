...
#define SBK_NATRON_NAMESPACE_ROTOSTROKETYPE_IDX                      39
...
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          15 // std::list<std::vector<std::string > > *
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                16 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       17 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            18 // std::map<ImageLayer, Effect * >
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       19 // const std::list<Track * > &
