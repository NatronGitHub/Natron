...
#define SBK_NATRON_NAMESPACE_VIEWERCONTEXTLAYOUTTYPEENUM_IDX         42
...
#define SBK_NATRON_NAMESPACE_TABLECHANGEREASONENUM_IDX               41
#define SBK_NATRON_NAMESPACE_ROTOSTROKETYPE_IDX                      38
#define SBK_NATRON_NAMESPACE_ORIENTATIONENUM_IDX                     36
#define SBK_NATRON_NAMESPACE_STANDARDBUTTONENUM_IDX                  39
#define SBK_QFLAGS_NATRON_NAMESPACE_STANDARDBUTTONENUM__IDX          49
#define SBK_NATRON_NAMESPACE_STATUSENUM_IDX                          40
...
#define SBK_PARAMETRICPARAM_IDX                                      46
#define SBK_PAGEPARAM_IDX                                            44
#define SBK_GROUPPARAM_IDX                                           20
#define SBK_SEPARATORPARAM_IDX                                       53
...
#define SBK_STRINGPARAMBASE_IDX                                      57
#define SBK_PATHPARAM_IDX                                            47
#define SBK_FILEPARAM_IDX                                            17
#define SBK_STRINGPARAM_IDX                                          55
#define SBK_STRINGPARAM_TYPEENUM_IDX                                 56
...
#define SBK_NATRONENGINE_STD_VECTOR_BOOL_IDX                         1 // const std::vector<bool > &
#define SBK_NATRONENGINE_STD_VECTOR_INT_IDX                          2 // const std::vector<int > &
...
#define SBK_NATRONENGINE_STD_VECTOR_DOUBLE_IDX                       5 // const std::vector<double > &
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        6 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   7 // const std::vector<std::string > &
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                8 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       9 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            10 // std::map<ImageLayer, Effect * >
#define SBK_NATRONENGINE_STD_LIST_ITEMBASEPTR_IDX                    11 // std::list<ItemBase * >
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       12 // const std::list<Track * > &
#define SBK_NATRONENGINE_STD_LIST_DOUBLE_IDX                         13 // std::list<double > *
#define SBK_NATRONENGINE_STD_LIST_STROKEPOINT_IDX                    14 // std::list<StrokePoint >
#define SBK_NATRONENGINE_STD_LIST_STD_LIST_STROKEPOINT_IDX           15 // std::list<std::list<StrokePoint > >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_NODECREATIONPROPERTYPTR_IDX 16 // const std::map<QString, NodeCreationProperty * > &
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        17 // std::list<QString >
#define SBK_NATRONENGINE_STD_LIST_INT_IDX                            18 // const std::list<int > &
#define SBK_NATRONENGINE_QLIST_QVARIANT_IDX                          19 // QList<QVariant >
#define SBK_NATRONENGINE_QLIST_QSTRING_IDX                           20 // QList<QString >
#define SBK_NATRONENGINE_QMAP_QSTRING_QVARIANT_IDX                   21 // QMap<QString, QVariant >
#define SBK_NatronEngine_CONVERTERS_IDX_COUNT                        22
