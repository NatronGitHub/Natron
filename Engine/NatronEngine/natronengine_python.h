...
// Type indices
#define SBK_COLORTUPLE_IDX                                           10
#define SBK_DOUBLE3DTUPLE_IDX                                        15
#define SBK_DOUBLE2DTUPLE_IDX                                        13
#define SBK_INT3DTUPLE_IDX                                           28
#define SBK_INT2DTUPLE_IDX                                           26
#define SBK_PARAM_IDX                                                36
#define SBK_ANIMATEDPARAM_IDX                                        0
#define SBK_INTPARAM_IDX                                             29
#define SBK_INT2DPARAM_IDX                                           25
#define SBK_USERPARAMHOLDER_IDX                                      52
#define SBK_IMAGELAYER_IDX                                           23
#define SBK_ROTO_IDX                                                 45
#define SBK_ITEMBASE_IDX                                             30
#define SBK_BEZIERCURVE_IDX                                          4
#define SBK_BEZIERCURVE_CAIROOPERATORENUM_IDX                        5
#define SBK_LAYER_IDX                                                32
#define SBK_APPSETTINGS_IDX                                          3
#define SBK_GROUP_IDX                                                19
#define SBK_APP_IDX                                                  2
#define SBK_EFFECT_IDX                                               17
#define SBK_PYCOREAPPLICATION_IDX                                    41
#define SBK_RECTD_IDX                                                43
#define SBK_RECTI_IDX                                                44
#define SBK_PARAMETRICPARAM_IDX                                      37
#define SBK_PAGEPARAM_IDX                                            35
#define SBK_GROUPPARAM_IDX                                           20
#define SBK_SEPARATORPARAM_IDX                                       46
#define SBK_BUTTONPARAM_IDX                                          7
#define SBK_STRINGPARAMBASE_IDX                                      51
#define SBK_STRINGPARAM_IDX                                          49
#define SBK_STRINGPARAM_TYPEENUM_IDX                                 50
#define SBK_PATHPARAM_IDX                                            38
#define SBK_OUTPUTFILEPARAM_IDX                                      34
#define SBK_FILEPARAM_IDX                                            18
#define SBK_BOOLEANPARAM_IDX                                         6
#define SBK_CHOICEPARAM_IDX                                          8
#define SBK_COLORPARAM_IDX                                           9
#define SBK_DOUBLEPARAM_IDX                                          16
#define SBK_DOUBLE2DPARAM_IDX                                        12
#define SBK_DOUBLE3DPARAM_IDX                                        14
#define SBK_INT3DPARAM_IDX                                           27
#define SBK_ANIMATIONLEVELENUM_IDX                                   1
#define SBK_KEYFRAMETYPEENUM_IDX                                     31
#define SBK_PIXMAPENUM_IDX                                           39
#define SBK_IMAGEPREMULTIPLICATIONENUM_IDX                           24
#define SBK_IMAGEBITDEPTHENUM_IDX                                    21
#define SBK_VIEWERCOMPOSITINGOPERATORENUM_IDX                        55
#define SBK_PLAYBACKMODEENUM_IDX                                     40
#define SBK_DISPLAYCHANNELSENUM_IDX                                  11
#define SBK_ORIENTATIONENUM_IDX                                      33
#define SBK_STANDARDBUTTONENUM_IDX                                   47
#define SBK_QFLAGS_STANDARDBUTTONENUM__IDX                           42
#define SBK_IMAGECOMPONENTSENUM_IDX                                  22
#define SBK_VALUECHANGEDREASONENUM_IDX                               53
#define SBK_STATUSENUM_IDX                                           48
#define SBK_VIEWERCOLORSPACEENUM_IDX                                 54
...
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   1 // const std::vector<std::string > &
...
#define SBK_NATRONENGINE_STD_LIST_INT_IDX                            4 // const std::list<int > &
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            5 // std::map<ImageLayer, Effect * >
#define SBK_NATRONENGINE_STD_LIST_PARAMPTR_IDX                       6 // std::list<Param * >
#define SBK_NATRONENGINE_STD_LIST_STD_STRING_IDX                     7 // const std::list<std::string > &
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        8 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_PAIR_STD_STRING_STD_STRING_IDX          9 // std::pair<std::string, std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_STD_STRING_STD_STRING_IDX 10 // const std::list<std::pair<std::string, std::string > > &
...
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::AnimationLevelEnum >() { return SbkNatronEngineTypes[SBK_ANIMATIONLEVELENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::KeyframeTypeEnum >() { return SbkNatronEngineTypes[SBK_KEYFRAMETYPEENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::PixmapEnum >() { return SbkNatronEngineTypes[SBK_PIXMAPENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ImagePremultiplicationEnum >() { return SbkNatronEngineTypes[SBK_IMAGEPREMULTIPLICATIONENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ImageBitDepthEnum >() { return SbkNatronEngineTypes[SBK_IMAGEBITDEPTHENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ViewerCompositingOperatorEnum >() { return SbkNatronEngineTypes[SBK_VIEWERCOMPOSITINGOPERATORENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::PlaybackModeEnum >() { return SbkNatronEngineTypes[SBK_PLAYBACKMODEENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::DisplayChannelsEnum >() { return SbkNatronEngineTypes[SBK_DISPLAYCHANNELSENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::OrientationEnum >() { return SbkNatronEngineTypes[SBK_ORIENTATIONENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::StandardButtonEnum >() { return SbkNatronEngineTypes[SBK_STANDARDBUTTONENUM_IDX]; }
template<> inline PyTypeObject* SbkType< ::QFlags<NATRON_NAMESPACE::StandardButtonEnum> >() { return SbkNatronEngineTypes[SBK_QFLAGS_STANDARDBUTTONENUM__IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ImageComponentsEnum >() { return SbkNatronEngineTypes[SBK_IMAGECOMPONENTSENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ValueChangedReasonEnum >() { return SbkNatronEngineTypes[SBK_VALUECHANGEDREASONENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::StatusEnum >() { return SbkNatronEngineTypes[SBK_STATUSENUM_IDX]; }
template<> inline PyTypeObject* SbkType<NATRON_NAMESPACE::ViewerColorSpaceEnum >() { return SbkNatronEngineTypes[SBK_VIEWERCOLORSPACEENUM_IDX]; }
