...
#define SBK_NATRON_NAMESPACE_IMAGECOMPONENTSENUM_IDX                 33
...
#define SBK_NATRON_NAMESPACE_DISPLAYCHANNELSENUM_IDX                 31
...
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       1 // std::list<Track * > *
#define SBK_NATRONENGINE_STD_LIST_PARAMPTR_IDX                       2 // std::list<Param * >
#define SBK_NATRONENGINE_STD_LIST_DOUBLE_IDX                         3 // std::list<double > *
...
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        13 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                14 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       15 // const std::list<std::pair<QString, QString > > &
