...
#define SBK_NATRONENGINE_STD_LIST_STROKEPOINT_IDX                    4 // std::list<StrokePoint >
#define SBK_NATRONENGINE_STD_LIST_STD_LIST_STROKEPOINT_IDX           5 // std::list<std::list<StrokePoint > >
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   6 // const std::vector<std::string > &
#define SBK_NATRONENGINE_STD_VECTOR_DOUBLE_IDX                       7 // const std::vector<double > &
#define SBK_NATRONENGINE_STD_VECTOR_BOOL_IDX                         8 // const std::vector<bool > &
#define SBK_NATRONENGINE_STD_VECTOR_INT_IDX                          9 // const std::vector<int > &
#define SBK_NATRONENGINE_STD_LIST_EFFECTPTR_IDX                      10 // std::list<Effect * >
...
#define SBK_NATRONENGINE_STD_LIST_ITEMSTABLEPTR_IDX                  14 // std::list<ItemsTable * >
#define SBK_NATRONENGINE_STD_LIST_IMAGELAYER_IDX                     15 // std::list<ImageLayer >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_QSTRING_IDX                 16 // const std::map<QString, QString > &
#define SBK_NATRONENGINE_STD_LIST_RECTI_IDX                          17 // std::list<RectI >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          18 // std::list<std::vector<std::string > > *
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                19 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       20 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_MAP_QSTRING_PYOVERLAYPARAMDESC_IDX      21 // std::map<QString, PyOverlayParamDesc >
