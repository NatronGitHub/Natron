...
#define SBK_NATRONENGINE_STD_LIST_ITEMBASEPTR_IDX                    1 // std::list<ItemBase * >
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       2 // const std::list<Track * > &
...
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        7 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   8 // std::vector<std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          9 // std::list<std::vector<std::string > > *
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                10 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       11 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_VECTOR_DOUBLE_IDX                       12 // const std::vector<double > &
#define SBK_NATRONENGINE_STD_VECTOR_BOOL_IDX                         13 // const std::vector<bool > &
#define SBK_NATRONENGINE_STD_VECTOR_INT_IDX                          14 // const std::vector<int > &
#define SBK_NATRONENGINE_STD_LIST_EFFECTPTR_IDX                      15 // std::list<Effect * >
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            16 // std::map<ImageLayer, Effect * >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_NODECREATIONPROPERTYPTR_IDX 17 // const std::map<QString, NodeCreationProperty * > &
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        18 // std::list<QString >
