...
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        15 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          16 // std::list<std::vector<std::string > > *
...
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            19 // std::map<ImageLayer, Effect * >
