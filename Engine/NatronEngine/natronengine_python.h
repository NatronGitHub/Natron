...
#define SBK_NATRONENGINE_STD_LIST_IMAGELAYER_IDX                     13 // std::list<ImageLayer >
...
#define SBK_NATRONENGINE_STD_LIST_STROKEPOINT_IDX                    16 // std::list<StrokePoint >
#define SBK_NATRONENGINE_STD_LIST_STD_LIST_STROKEPOINT_IDX           17 // std::list<std::list<StrokePoint > >
