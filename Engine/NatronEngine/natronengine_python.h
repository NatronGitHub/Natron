...
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                20 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       21 // const std::list<std::pair<QString, QString > > &
