...
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          13 // std::list<std::vector<std::string > > *
...
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       17 // std::list<Track * > *
