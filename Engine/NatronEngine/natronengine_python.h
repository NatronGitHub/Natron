...
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   5 // const std::vector<std::string > &
...
#define SBK_NATRONENGINE_STD_LIST_EFFECTPTR_IDX                      9 // std::list<Effect * >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_NODECREATIONPROPERTYPTR_IDX 10 // const std::map<QString, NodeCreationProperty * > &
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        11 // std::list<QString >
#define SBK_NATRONENGINE_STD_LIST_INT_IDX                            12 // const std::list<int > &
...
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       16 // const std::list<Track * > &
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                17 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       18 // const std::list<std::pair<QString, QString > > &
