...
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                1 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       2 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_LIST_ITEMBASEPTR_IDX                    3 // std::list<ItemBase * >
#define SBK_NATRONENGINE_STD_LIST_TRACKPTR_IDX                       4 // const std::list<Track * > &
...
#define SBK_NATRONENGINE_STD_LIST_STROKEPOINT_IDX                    7 // std::list<StrokePoint >
#define SBK_NATRONENGINE_STD_LIST_STD_LIST_STROKEPOINT_IDX           8 // std::list<std::list<StrokePoint > >
...
#define SBK_NATRONENGINE_STD_MAP_IMAGELAYER_EFFECTPTR_IDX            17 // std::map<ImageLayer, Effect * >
#define SBK_NATRONENGINE_STD_VECTOR_RECTI_IDX                        18 // std::vector<RectI >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          19 // std::list<std::vector<std::string > > *
