...
#define SBK_NATRONENGINE_STD_MAP_QSTRING_PYOVERLAYPARAMDESC_IDX      1 // std::map<QString, PyOverlayParamDesc >
#define SBK_NATRONENGINE_STD_MAP_QSTRING_QSTRING_IDX                 2 // const std::map<QString, QString > &
...
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   9 // std::vector<std::string >
#define SBK_NATRONENGINE_STD_LIST_STD_VECTOR_STD_STRING_IDX          10 // std::list<std::vector<std::string > > *
#define SBK_NATRONENGINE_STD_LIST_QSTRING_IDX                        11 // std::list<QString > *
#define SBK_NATRONENGINE_STD_PAIR_QSTRING_QSTRING_IDX                12 // std::pair<QString, QString >
#define SBK_NATRONENGINE_STD_LIST_STD_PAIR_QSTRING_QSTRING_IDX       13 // const std::list<std::pair<QString, QString > > &
#define SBK_NATRONENGINE_STD_LIST_RECTI_IDX                          14 // std::list<RectI >
...
#define SBK_NATRONENGINE_STD_LIST_ITEMSTABLEPTR_IDX                  20 // std::list<ItemsTable * >
#define SBK_NATRONENGINE_STD_LIST_IMAGELAYER_IDX                     21 // std::list<ImageLayer >
