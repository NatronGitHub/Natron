...
#define SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX                   1 // std::vector<std::string >
...
#define SBK_NATRONENGINE_STD_LIST_STD_STRING_IDX                     8 // std::list<std::string >
#define SBK_NATRONENGINE_QLIST_QVARIANT_IDX                          9 // QList<QVariant >
#define SBK_NATRONENGINE_QLIST_QSTRING_IDX                           10 // QList<QString >
#define SBK_NATRONENGINE_QMAP_QSTRING_QVARIANT_IDX                   11 // QMap<QString, QVariant >
#define SBK_NatronEngine_CONVERTERS_IDX_COUNT                        12
