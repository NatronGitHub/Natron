...
struct RotoContextPrivate
{
    ...
    , globalMergeNodes()
    {
        ...
        generalPage = natronCreateKnob<KnobPage>(effect, "General", 1, false);
        shapePage = natronCreateKnob<KnobPage>(effect, "Shape", 1, false);
        strokePage = natronCreateKnob<KnobPage>(effect, "Stroke", 1, false);
        clonePage = natronCreateKnob<KnobPage>(effect, "Clone", 1, false);
        transformPage = natronCreateKnob<KnobPage>(effect, "Transform", 1, false);
        
        boost::shared_ptr<KnobDouble> opacityKnob = natronCreateKnob<KnobDouble>(effect, kRotoOpacityParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobColor> ck = natronCreateKnob<KnobColor>(effect, kRotoColorParamLabel, 3, false);
        ...
        boost::shared_ptr<KnobChoice> lifeTimeKnob = natronCreateKnob<KnobChoice>(effect, kRotoDrawableItemLifeTimeParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobInt> lifeTimeFrameKnob = natronCreateKnob<KnobInt>(effect, kRotoDrawableItemLifeTimeFrameParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobBool> activatedKnob = natronCreateKnob<KnobBool>(effect, kRotoActivatedParamLabel, 1, false);
...
#ifdef NATRON_ROTO_INVERTIBLE
        boost::shared_ptr<KnobBool> invertedKnob = natronCreateKnob<KnobBool>(effect, kRotoInvertedParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobDouble> featherKnob = natronCreateKnob<KnobDouble>(effect, kRotoFeatherParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobDouble> featherFallOffKnob = natronCreateKnob<KnobDouble>(effect, kRotoFeatherFallOffParamLabel, 1, false);
        ...
        {
            boost::shared_ptr<KnobChoice> sourceType = natronCreateKnob<KnobChoice>(effect,kRotoBrushSourceColorLabel,1,false);
            ...
            boost::shared_ptr<KnobDouble> translate = natronCreateKnob<KnobDouble>(effect, kRotoBrushTranslateParamLabel, 2, false);
            ...
            boost::shared_ptr<KnobDouble> rotate = natronCreateKnob<KnobDouble>(effect, kRotoBrushRotateParamLabel, 1, false);
            ...
            boost::shared_ptr<KnobDouble> scale = natronCreateKnob<KnobDouble>(effect, kRotoBrushScaleParamLabel, 2, false);
            ...
            boost::shared_ptr<KnobBool> scaleUniform = natronCreateKnob<KnobBool>(effect, kRotoBrushScaleUniformParamLabel, 1, false);
            ...
            boost::shared_ptr<KnobDouble> skewX = natronCreateKnob<KnobDouble>(effect, kRotoBrushSkewXParamLabel, 1, false);
            ...
            boost::shared_ptr<KnobDouble> skewY = natronCreateKnob<KnobDouble>(effect, kRotoBrushSkewYParamLabel, 1, false);
            ...
            boost::shared_ptr<KnobChoice> skewOrder = natronCreateKnob<KnobChoice>(effect,kRotoBrushSkewOrderParamLabel,1,false);
            ...
            boost::shared_ptr<KnobDouble> center = natronCreateKnob<KnobDouble>(effect, kRotoBrushCenterParamLabel, 2, false);
            ...
            boost::shared_ptr<KnobButton> resetCloneCenter = natronCreateKnob<KnobButton>(effect, kRotoResetCloneCenterParamLabel, 1 , true);
            ...
            boost::shared_ptr<KnobButton> resetCloneTransform = natronCreateKnob<KnobButton>(effect, kRotoResetCloneTransformParamLabel, 1 , true);
            ...
            boost::shared_ptr<KnobChoice> filter = natronCreateKnob<KnobChoice>(effect,kRotoBrushFilterParamLabel,1,false);
            ...
            boost::shared_ptr<KnobBool> blackOutside = natronCreateKnob<KnobBool>(effect, kRotoBrushBlackOutsideParamLabel, 1, false);
            ...
            boost::shared_ptr<KnobInt> timeOffset = natronCreateKnob<KnobInt>(effect, kRotoBrushTimeOffsetParamLabel, 1, false);
            timeOffset->setName(kRotoBrushTimeOffsetParam);
            timeOffset->setHintToolTip(kRotoBrushTimeOffsetParamHint);
            timeOffset->setDisplayMinimum(-100);
            timeOffset->setDisplayMaximum(100);
            ...
            boost::shared_ptr<KnobChoice> timeOffsetMode = natronCreateKnob<KnobChoice>(effect, kRotoBrushTimeOffsetModeParamLabel, 1, false);
            timeOffsetMode->setName(kRotoBrushTimeOffsetModeParam);
            timeOffsetMode->setHintToolTip(kRotoBrushTimeOffsetModeParamHint);
            {
                std::vector<std::string> modes;
            ...
            boost::shared_ptr<KnobDouble> brushSize = natronCreateKnob<KnobDouble>(effect, kRotoBrushSizeParamLabel, 1, false);
            brushSize->setName(kRotoBrushSizeParam);
            brushSize->setHintToolTip(kRotoBrushSizeParamHint);
            brushSize->setDefaultValue(25);
            brushSize->setMinimum(1.);
            ...
            boost::shared_ptr<KnobDouble> brushSpacing = natronCreateKnob<KnobDouble>(effect, kRotoBrushSpacingParamLabel, 1, false);
            brushSpacing->setName(kRotoBrushSpacingParam);
            brushSpacing->setHintToolTip(kRotoBrushSpacingParamHint);
            brushSpacing->setDefaultValue(0.1);
            brushSpacing->setMinimum(0.);
            ...
            boost::shared_ptr<KnobDouble> brushHardness = natronCreateKnob<KnobDouble>(effect, kRotoBrushHardnessParamLabel, 1, false);
            brushHardness->setName(kRotoBrushHardnessParam);
            brushHardness->setHintToolTip(kRotoBrushHardnessParamHint);
            brushHardness->setDefaultValue(0.2);
            brushHardness->setMinimum(0.);
            ...
            boost::shared_ptr<KnobDouble> effectStrength = natronCreateKnob<KnobDouble>(effect, kRotoBrushEffectParamLabel, 1, false);
            effectStrength->setName(kRotoBrushEffectParam);
            effectStrength->setHintToolTip(kRotoBrushEffectParamHint);
            effectStrength->setDefaultValue(15);
            effectStrength->setMinimum(0.);
            ...
            boost::shared_ptr<KnobString> pressureLabel = natronCreateKnob<KnobString>(effect, kRotoBrushPressureLabelParamLabel);
            ...
            boost::shared_ptr<KnobBool> pressureOpacity = natronCreateKnob<KnobBool>(effect, kRotoBrushPressureOpacityParamLabel);
            pressureOpacity->setName(kRotoBrushPressureOpacityParam);
            pressureOpacity->setHintToolTip(kRotoBrushPressureOpacityParamHint);
            pressureOpacity->setAnimationEnabled(false);
            pressureOpacity->setDefaultValue(true);
            ...
            boost::shared_ptr<KnobBool> pressureSize = natronCreateKnob<KnobBool>(effect, kRotoBrushPressureSizeParamLabel);
            pressureSize->setName(kRotoBrushPressureSizeParam);
            pressureSize->setHintToolTip(kRotoBrushPressureSizeParamHint);
            pressureSize->setAnimationEnabled(false);
            pressureSize->setDefaultValue(false);
            ...
            boost::shared_ptr<KnobBool> pressureHardness = natronCreateKnob<KnobBool>(effect, kRotoBrushPressureHardnessParamLabel);
            pressureHardness->setName(kRotoBrushPressureHardnessParam);
            pressureHardness->setHintToolTip(kRotoBrushPressureHardnessParamHint);
            pressureHardness->setAnimationEnabled(false);
            pressureHardness->setDefaultValue(false);
            ...
            boost::shared_ptr<KnobBool> buildUp = natronCreateKnob<KnobBool>(effect, kRotoBrushBuildupParamLabel);
            buildUp->setName(kRotoBrushBuildupParam);
            buildUp->setHintToolTip(kRotoBrushBuildupParamHint);
            buildUp->setAnimationEnabled(false);
            buildUp->setDefaultValue(false);
            ...
            boost::shared_ptr<KnobDouble> visiblePortion = natronCreateKnob<KnobDouble>(effect, kRotoBrushVisiblePortionParamLabel, 2, false);
            visiblePortion->setName(kRotoBrushVisiblePortionParam);
            visiblePortion->setHintToolTip(kRotoBrushVisiblePortionParamHint);
            visiblePortion->setDefaultValue(0, 0);
            visiblePortion->setDefaultValue(1, 1);
        ...
        boost::shared_ptr<KnobDouble> translate = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemTranslateParamLabel, 2, false);
        translate->setName(kRotoDrawableItemTranslateParam);
        translate->setHintToolTip(kRotoDrawableItemTranslateParamHint);
        translate->setDefaultAllDimensionsEnabled(false);
        translate->setIncrement(10);
        ...
        boost::shared_ptr<KnobDouble> rotate = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemRotateParamLabel, 1, false);
        rotate->setName(kRotoDrawableItemRotateParam);
        rotate->setHintToolTip(kRotoDrawableItemRotateParamHint);
        rotate->setDefaultAllDimensionsEnabled(false);
        rotate->setDisplayMinimum(-180);
        ...
        boost::shared_ptr<KnobDouble> scale = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemScaleParamLabel, 2, false);
        scale->setName(kRotoDrawableItemScaleParam);
        scale->setHintToolTip(kRotoDrawableItemScaleParamHint);
        scale->setDefaultValue(1,0);
        scale->setDefaultValue(1,1);
        ...
        boost::shared_ptr<KnobBool> scaleUniform = natronCreateKnob<KnobBool>(effect, kRotoDrawableItemScaleUniformParamLabel, 1, false);
        scaleUniform->setName(kRotoDrawableItemScaleUniformParam);
        scaleUniform->setHintToolTip(kRotoDrawableItemScaleUniformParamHint);
        scaleUniform->setDefaultValue(true);
        scaleUniform->setDefaultAllDimensionsEnabled(false);
        ...
        boost::shared_ptr<KnobDouble> skewX = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemSkewXParamLabel, 1, false);
        skewX->setName(kRotoDrawableItemSkewXParam);
        skewX->setHintToolTip(kRotoDrawableItemSkewXParamHint);
        skewX->setDefaultAllDimensionsEnabled(false);
        skewX->setDisplayMinimum(-1,0);
        ...
        boost::shared_ptr<KnobDouble> skewY = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemSkewYParamLabel, 1, false);
        skewY->setName(kRotoDrawableItemSkewYParam);
        skewY->setHintToolTip(kRotoDrawableItemSkewYParamHint);
        skewY->setDefaultAllDimensionsEnabled(false);
        skewY->setDisplayMinimum(-1,0);
        ...
        boost::shared_ptr<KnobChoice> skewOrder = natronCreateKnob<KnobChoice>(effect,kRotoDrawableItemSkewOrderParamLabel,1,false);
        skewOrder->setName(kRotoDrawableItemSkewOrderParam);
        skewOrder->setHintToolTip(kRotoDrawableItemSkewOrderParamHint);
        skewOrder->setDefaultValue(0);
        {
        ...
        boost::shared_ptr<KnobDouble> center = natronCreateKnob<KnobDouble>(effect, kRotoDrawableItemCenterParamLabel, 2, false);
        center->setName(kRotoDrawableItemCenterParam);
        center->setHintToolTip(kRotoDrawableItemCenterParamHint);
        center->setDefaultAllDimensionsEnabled(false);
        center->setDefaultValuesAreNormalized(true);
        ...
        boost::shared_ptr<KnobButton> resetCenter = natronCreateKnob<KnobButton>(effect, kRotoResetCenterParamLabel, 1 , true);
        ...
        boost::shared_ptr<KnobButton> resetTransform = natronCreateKnob<KnobButton>(effect, kRotoResetTransformParamLabel, 1 , true);
...
#ifdef NATRON_ROTO_ENABLE_MOTION_BLUR
        boost::shared_ptr<KnobPage> mbPage = natronCreateKnob<KnobPage>(effect, "Motion Blur", 1, false);
        boost::shared_ptr<KnobChoice> motionBlurType = natronCreateKnob<KnobChoice>(effect, kRotoMotionBlurModeParamLabel, 1, true);
        ...
        boost::shared_ptr<KnobDouble> motionBlur = natronCreateKnob<KnobDouble>(effect, kRotoMotionBlurParamLabel, 1, false);
        motionBlur->setName(kRotoPerShapeMotionBlurParam);
        motionBlur->setHintToolTip(kRotoMotionBlurParamHint);
        motionBlur->setDefaultValue(0);
        motionBlur->setMinimum(0);
        ...
        boost::shared_ptr<KnobDouble> shutter = natronCreateKnob<KnobDouble>(effect, kRotoShutterParamLabel, 1, false);
        shutter->setName(kRotoPerShapeShutterParam);
        shutter->setHintToolTip(kRotoShutterParamHint);
        shutter->setDefaultValue(0.5);
        shutter->setMinimum(0);
        ...
        boost::shared_ptr<KnobChoice> shutterType = natronCreateKnob<KnobChoice>(effect, kRotoShutterOffsetTypeParamLabel, 1, false);
        shutterType->setName(kRotoPerShapeShutterOffsetTypeParam);
        shutterType->setHintToolTip(kRotoShutterOffsetTypeParamHint);
        shutterType->setDefaultValue(0);
        {
        ...
        boost::shared_ptr<KnobDouble> customOffset = natronCreateKnob<KnobDouble>(effect, kRotoShutterCustomOffsetParamLabel, 1, false);
        customOffset->setName(kRotoPerShapeShutterCustomOffsetParam);
        customOffset->setHintToolTip(kRotoShutterCustomOffsetParamHint);
        customOffset->setDefaultValue(0);
        ...
        boost::shared_ptr<KnobDouble> globalMotionBlur = natronCreateKnob<KnobDouble>(effect, kRotoMotionBlurParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobDouble> globalShutter = natronCreateKnob<KnobDouble>(effect, kRotoShutterParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobChoice> globalShutterType = natronCreateKnob<KnobChoice>(effect, kRotoShutterOffsetTypeParamLabel, 1, false);
        ...
        boost::shared_ptr<KnobDouble> globalCustomOffset = natronCreateKnob<KnobDouble>(effect, kRotoShutterCustomOffsetParamLabel, 1, false);
