...
#ifndef NATRON_ENGINE_IMAGECACHEKEY_H
#define NATRON_ENGINE_IMAGECACHEKEY_H
...
private:
    ...
    boost::scoped_ptr<ImageCacheKeyPrivate> _imp;
};

inline
ImageCacheKeyPtr toImageCacheKey(const CacheEntryKeyBasePtr& key)
{
