...
KnobHelperPrivate::parseListenersFromExpression(int dimension)
{
    ...
    std::string error;
    bool ok = interpretPythonScript(script, &error,NULL);
    if (!error.empty()) {
        qDebug() << error.c_str();
    }
    assert(ok);
...
KnobHolder::getOrCreateUserPageKnob() 
{
    ...
    ret = natronCreateKnob<KnobPage>(this,NATRON_USER_MANAGED_KNOBS_PAGE_LABEL,1,false);
    ret->setAsUserKnob();
...
KnobHolder::createIntKnob(const std::string& name, const std::string& label,int dimension)
{
    ...
    boost::shared_ptr<KnobInt> ret = natronCreateKnob<KnobInt>(this,label, dimension, false);
    ret->setName(name);
    ret->setAsUserKnob();
...
KnobHolder::createDoubleKnob(const std::string& name, const std::string& label,int dimension)
{
    ...
    boost::shared_ptr<KnobDouble> ret = natronCreateKnob<KnobDouble>(this,label, dimension, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createColorKnob(const std::string& name, const std::string& label,int dimension)
{
    ...
    boost::shared_ptr<KnobColor> ret = natronCreateKnob<KnobColor>(this,label, dimension, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createBoolKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobBool> ret = natronCreateKnob<KnobBool>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createChoiceKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobChoice> ret = natronCreateKnob<KnobChoice>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createButtonKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobButton> ret = natronCreateKnob<KnobButton>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createSeparatorKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobSeparator> ret = natronCreateKnob<KnobSeparator>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
     Q_UNUSED(pageknob);*/
...
KnobHolder::createStringKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobString> ret = natronCreateKnob<KnobString>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createFileKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobFile> ret = natronCreateKnob<KnobFile>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createOuptutFileKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobOutputFile> ret = natronCreateKnob<KnobOutputFile>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createPathKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobPath> ret = natronCreateKnob<KnobPath>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createGroupKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobGroup> ret = natronCreateKnob<KnobGroup>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createPageKnob(const std::string& name, const std::string& label)
{
    ...
    boost::shared_ptr<KnobPage> ret = natronCreateKnob<KnobPage>(this,label, 1, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
...
KnobHolder::createParametricKnob(const std::string& name, const std::string& label,int nbCurves)
{
    ...
    boost::shared_ptr<KnobParametric> ret = natronCreateKnob<KnobParametric>(this,label, nbCurves, false);
    ret->setName(name);
    ret->setAsUserKnob();
    /*boost::shared_ptr<KnobPage> pageknob = getOrCreateUserPageKnob();
    Q_UNUSED(pageknob);*/
