                               ...
                               const OfxRGBAColourD* colourPicker)
{
    ...
    OfxStatus stat = OFX::Host::ImageEffect::OverlayInteract::drawAction(time, renderScale, view, colourPicker);
...
{
    //OGLContextSaver s(_viewport);
    return OFX::Host::ImageEffect::OverlayInteract::penMotionAction(time, renderScale, view, colourPicker, penPos, penPosViewport, pressure);
}
...
OfxOverlayInteract::penUpAction(OfxTime time,
                                ...
                                double pressure)
{
    return OFX::Host::ImageEffect::OverlayInteract::penUpAction(time, renderScale, view, colourPicker, penPos, penPosViewport, pressure);
}
...
OfxOverlayInteract::penDownAction(OfxTime time,
                                  ...
                                  double pressure)
{
    return OFX::Host::ImageEffect::OverlayInteract::penDownAction(time, renderScale, view, colourPicker, penPos, penPosViewport, pressure);
}
...
OfxOverlayInteract::keyDownAction(OfxTime time,
                                  ...
                                  char*   keyString)
{
    return OFX::Host::ImageEffect::OverlayInteract::keyDownAction(time, renderScale, view, colourPicker, key, keyString);
}
...
OfxOverlayInteract::keyUpAction(OfxTime time,
                                ...
                                char*   keyString)
{
    return OFX::Host::ImageEffect::OverlayInteract::keyUpAction(time, renderScale, view, colourPicker, key, keyString);
}
...
OfxOverlayInteract::keyRepeatAction(OfxTime time,
                                    ...
                                    char*   keyString)
{
    return OFX::Host::ImageEffect::OverlayInteract::keyRepeatAction(time, renderScale, view, colourPicker, key, keyString);
}
...
OfxOverlayInteract::gainFocusAction(OfxTime time,
                                    ...
                                    const OfxRGBAColourD* colourPicker)
{
    return OFX::Host::ImageEffect::OverlayInteract::gainFocusAction(time, renderScale, view, colourPicker);
}
...
OfxOverlayInteract::loseFocusAction(OfxTime time,
                                    ...
                                    const OfxRGBAColourD* colourPicker)
{
    return OFX::Host::ImageEffect::OverlayInteract::loseFocusAction(time, renderScale, view, colourPicker);
}
