...
PySide::Feature::Select(self);
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.FloatNodeCreationProperty.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_FloatNodeCreationPropertyFunc_getValues(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.FloatNodeCreationProperty.getValues";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_FloatNodeCreationPropertyFunc_setValue(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.FloatNodeCreationProperty.setValue";
    SBK_UNUSED(fullName)
    int overloadId = -1;
