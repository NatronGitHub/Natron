...
static PyObject *Sbk_ParamFunc__addAsDependencyOf(PyObject *self, PyObject *args)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param._addAsDependencyOf";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_ParamFunc_copy(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.copy";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_ParamFunc_curve(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.curve";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { nullptr, nullptr };
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_getAddNewLine(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getAddNewLine";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getCanAnimate(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getCanAnimate";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getEvaluateOnChange(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getEvaluateOnChange";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getHelp(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getHelp";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getIsAnimationEnabled(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getIsAnimationEnabled";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getIsEnabled(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getIsEnabled";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_ParamFunc_getIsPersistent(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getIsPersistent";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getIsVisible(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getIsVisible";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getLabel(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getLabel";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getNumDimensions(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getNumDimensions";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getParent(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getParent";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getScriptName(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getScriptName";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_getTypeName(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.getTypeName";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_ParamFunc_random(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.random";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    ...
    switch (overloadId) {
        case 0: // random(double min, double max) const
        {
            if (kwds) {
                PyObject *value{};
                PyObject *kwds_dup = PyDict_Copy(kwds);
                static PyObject *const key_min = Shiboken::String::createStaticString("min");
                if (PyDict_Contains(kwds, key_min)) {
                    value = PyDict_GetItem(kwds, key_min);
                    if (value && pyArgs[0]) {
                        errInfo = key_min;
                        Py_INCREF(errInfo);
                        goto Sbk_ParamFunc_random_TypeError;
                    ...
                    PyDict_DelItem(kwds_dup, key_min);
                }
                static PyObject *const key_max = Shiboken::String::createStaticString("max");
                if (PyDict_Contains(kwds, key_max)) {
                    value = PyDict_GetItem(kwds, key_max);
                    if (value && pyArgs[1]) {
                        errInfo = key_max;
                        Py_INCREF(errInfo);
                        goto Sbk_ParamFunc_random_TypeError;
                    ...
                    PyDict_DelItem(kwds_dup, key_max);
                }
                if (PyDict_Size(kwds_dup) > 0) {
                    errInfo = kwds_dup;
                    goto Sbk_ParamFunc_random_TypeError;
...
static PyObject *Sbk_ParamFunc_randomInt(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.randomInt";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { nullptr, nullptr, nullptr, nullptr };
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setAddNewLine(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setAddNewLine";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_ParamFunc_setAnimationEnabled(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setAnimationEnabled";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setAsAlias(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setAsAlias";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setEnabled(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setEnabled";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { nullptr, nullptr };
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setEnabledByDefault(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setEnabledByDefault";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { nullptr };
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setEvaluateOnChange(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setEvaluateOnChange";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setHelp(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setHelp";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setIconFilePath(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setIconFilePath";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setPersistent(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setPersistent";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setVisible(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setVisible";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_setVisibleByDefault(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.setVisibleByDefault";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_slaveTo(PyObject *self, PyObject *args)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.slaveTo";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp[] = { nullptr, nullptr, nullptr };
    SBK_UNUSED(pythonToCpp)
...
static PyObject *Sbk_ParamFunc_unslave(PyObject *self, PyObject *pyArg)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.Param.unslave";
    SBK_UNUSED(fullName)
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)
