...
PySide::Feature::Select(self);
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.IntNodeCreationProperty.__init__";
    SBK_UNUSED(fullName)
    int overloadId = -1;
...
static PyObject *Sbk_IntNodeCreationPropertyFunc_getValues(PyObject *self)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.IntNodeCreationProperty.getValues";
    SBK_UNUSED(fullName)
...
static PyObject *Sbk_IntNodeCreationPropertyFunc_setValue(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *errInfo{};
    SBK_UNUSED(errInfo)
    static const char *fullName = "NatronEngine.IntNodeCreationProperty.setValue";
    SBK_UNUSED(fullName)
    int overloadId = -1;
