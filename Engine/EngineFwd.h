...
typedef boost::shared_ptr<const EffectInstance> EffectInstanceConstPtr;
...
typedef boost::shared_ptr<const GroupKnobSerialization> GroupKnobSerializationConstPtr;
...
typedef boost::shared_ptr<RotoSmear> RotoSmearPtr;
