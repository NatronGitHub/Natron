...
typedef boost::shared_ptr<const TrackMarker> TrackMarkerConstPtr;
...
typedef boost::shared_ptr<const TreeRenderQueueProvider> TreeRenderQueueProviderConstPtr;
...
typedef boost::weak_ptr<const TreeRenderQueueProvider> TreeRenderQueueProviderConstWPtr;
