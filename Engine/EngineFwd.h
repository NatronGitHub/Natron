...
class GetDistorsionKey;
class GetDistorsionResults;
...
class GetComponentsNeededKey;
class GetComponentsNeededResults;
class GroupInput;
class GroupOutput;
class Hash64;
...
typedef boost::shared_ptr<CacheFetcher> CacheFetcherPtr;
...
typedef boost::shared_ptr<DistorsionFunction2D> DistorsionFunction2DPtr;
typedef boost::shared_ptr<Distorsion2DStack> Distorsion2DStackPtr;
...
typedef boost::shared_ptr<GetDistorsionKey> GetDistorsionKeyPtr;
typedef boost::shared_ptr<GetDistorsionResults> GetDistorsionResultsPtr;
...
typedef boost::shared_ptr<GetComponentsNeededKey> GetComponentsNeededKeyPtr;
typedef boost::shared_ptr<GetComponentsNeededResults> GetComponentsNeededResultsPtr;
typedef boost::shared_ptr<GLCacheEntry> GLCacheEntryPtr;
...
typedef boost::shared_ptr<ImageTileKey> ImageTileKeyPtr;
...
typedef boost::shared_ptr<MemoryBufferedCacheEntryBase> MemoryBufferedCacheEntryBasePtr;
typedef boost::shared_ptr<MemoryMappedCacheEntry> MemoryMappedCacheEntryPtr;
...
typedef boost::shared_ptr<RAMCacheEntry> RAMCacheEntryPtr;
...
typedef boost::shared_ptr<TreeRenderNodeArgs> TreeRenderNodeArgsPtr;
