...
win32-msvc*{
        CONFIG(64bit) {
                CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/x64/release/ -lqtkeychain
                CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/x64/debug/ -lqtkeychain
        } else {
                CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/win32/release/ -lqtkeychain
                CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/win32/debug/ -lqtkeychain
        }
} else {
        win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/release/ -lqtkeychain
        else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/debug/ -lqtkeychain
        else:*-xcode:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/Release/ -lqtkeychain
        else:*-xcode:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/qtkeychain/Debug/ -lqtkeychain
        else:unix: LIBS += -L$$OUT_PWD/../libs/qtkeychain/ -lqtkeychain
}

win32-msvc*{
        CONFIG(64bit) {
                CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/x64/release/libqtkeychain.lib
                CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/x64/debug/libqtkeychain.lib
        } else {
                CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/win32/release/libqtkeychain.lib
                CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/win32/debug/libqtkeychain.lib
        }
} else {
        win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/release/libqtkeychain.lib
        else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/debug/libqtkeychain.lib
        else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/release/libqtkeychain.lib
        else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/debug/libqtkeychain.lib
        else:*-xcode:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/Release/libqtkeychain.a
        else:*-xcode:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/Debug/libqtkeychain.a
        else:unix: PRE_TARGETDEPS += $$OUT_PWD/../libs/qtkeychain/libqtkeychain.a
}
} # static-qtkeychain
